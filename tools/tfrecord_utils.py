...
def _process_image(filename, coder):
    ...
    """
    # Read the image file.
    # Note: tf bug using 'r' will give an error, and cannot be decoded, it can only be read in binary form
    ...
    # image = Image.open(filename) # The image must be of type array
